...
import SearchIngredientBar from "../component_menu_management_service/SearchIngredientBar";
import "../css_menu_management_service/EditIngredientCSS.css";
import { updateIngredient } from "../../../api/UpdateIngredientApi";
...
function EditIngredient() {
    ...
    const [targetIngredientToEdit, setTargetIngredientToEdit] = useState("");

    const [toastResponseMessage, setToastResponseMessage] = useState("");
    const [showToast, setShowToast] = useState(false);

    const [currentIngredientData, setCurrentIngredientData] = useState(null);
    ...
    async function handleUpdateIngredient() {
        ...
        if (
            ...
            let ingredient_to_update = {
                ...
                availabilityStatus: currentIngredientData.availabilityStatus
            };

            try {
                const response = await updateIngredient(ingredient_to_update);
                ...
                if (error.response) {
                    ...
                    setToastResponseMessage(error.response?.data?.message || "An unexpected error occurred.");
                    setShowToast(true);
                    setTimeout(() => {
                        setShowToast(false);
                    }, 10000);
        ...
        <>
            {showToast && (
                <div className="toastBox">
                    <span>{toastResponseMessage}</span>
                    <button
            ...
            <div className="EditIngredient p-4">
                <SearchIngredientBar
                    targetIngredientToEdit={targetIngredientToEdit}
                    setTargetIngredientToEdit={setTargetIngredientToEdit}
                    setToastResponseMessage={setToastResponseMessage}
                    setShowToast={setShowToast}
                    setCurrentIngredientData={setCurrentIngredientData}
                />
            </div>
                ...
                {currentIngredientData && (
                    <form className="IngredientForm p-4">
                        <div className="formHeading mb-3">
                            <h3>Enter The New Details To Update..</h3>
                        </div>
                        ...
                        <div className="row mb-3">
                            <div className="col-md-6">
                                ...
                                <input
                                    ...
                                    id="ingredientName"
                                    name="ingredientName"
                                    placeholder={currentIngredientData.name}
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-md-6">
                                ...
                                <input
                                    ...
                                    placeholder={currentIngredientData.calories}
                        ...
                        <div className="row mb-3">
                            <div className="col-md-6">
                                ...
                                <input
                                    ...
                                    placeholder={currentIngredientData.protein}
                            ...
                            <div className="col-md-6">
                                ...
                                <input
                                    ...
                                    id="ingredientFat"
                                    name="ingredientFat"
                                    placeholder={currentIngredientData.fat}
                                    value={ingredientFat}
                        ...
                        <div className="row mb-4">
                            <div className="col-md-6">
                                ...
                                <input
                                    ...
                                    placeholder={currentIngredientData.carbohydrates}
                            ...
                            <div className="col-md-6">
                                ...
                                <input
                                    ...
                                    placeholder={currentIngredientData.fiber}
