...
import SearchProductBar from "../component_menu_management_service/SearchProductBar"
import "../css_menu_management_service/EditProductCSS.css"
...
function EditProduct(){
        ...
        async function handleUpdateProduct() {
            ...
            if (
                ...
                let product_to_update = {
                    ...
                    fat: productFat,
                    fiber: productFiber,
                    availabilityStatus: currentProductData.availabilityStatus
                };
    
                try 
                {
                    const response = await updateProduct(product_to_update);
    ...
    return(
        <>
            ...
            <div className="EditProduct p-4">
                <SearchProductBar targetProductToEdit={targetProductToEdit}  setTargetProductToEdit={setTargetProductToEdit} setToastResponseMessage={setToastResponseMessage} setShowToast={setShowToast} setCurrentProductData={setCurrentProductData} />
            </div>
                        ...
                        <form className='ProductForm p-4'>
                                ...
                                <div className="row mb-3">
                                    <div className="col-md-6">
                                        ...
                                        <input
                                            ...
                                            id="productName"
                                            name="productName"
                                            placeholder={currentProductData.name}
                                            value={productName}
                                ...
                                <div className="mb-3">
                                    ...
                                    <textarea
                                        ...
                                        rows="5"
                                        placeholder={currentProductData.description}
                                ...
                                <div className="row mb-3">
                                    <div className="col-md-6">
                                        ...
                                        <input
                                            ...
                                            id="productTag"
                                            name="productTag"
                                            placeholder={currentProductData.tag}
                                            value={productTag}
                                ...
                                <div className="row mb-3">
                                    <div className="col-md-6">
                                        ...
                                        <input
                                            ...
                                            id="productPrice"
                                            name="productPrice"
                                            placeholder={currentProductData.price}
                                            value={productPrice}
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <input
                                            ...
                                            placeholder={currentProductData.calories}
                                ...
                                <div className="row mb-3">
                                    <div className="col-md-6">
                                        ...
                                        <input
                                            ...
                                            id="productProtein"
                                            name="productProtein"
                                            placeholder={currentProductData.protein}
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <input
                                            ...
                                            id="productFat"
                                            name="productFat"
                                            placeholder={currentProductData.fat}
                                            value={productFat}
                                ...
                                <div className="row mb-4">
                                    <div className="col-md-6">
                                        ...
                                        <input
                                            ...
                                            placeholder={currentProductData.carbohydrates}
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <input
                                            ...
                                            id="productFiber"
                                            name="productFiber"
                                            placeholder={currentProductData.fiber}
                                            value={productFiber}
                                ...
                                <div className='d-flex justify-content-center'>
                                    <button type="button" id="AddProductBtn" className="btn w-50" onClick={handleUpdateProduct}>
                                        UPDATE PRODUCT
                                    </button>
                                </div>
